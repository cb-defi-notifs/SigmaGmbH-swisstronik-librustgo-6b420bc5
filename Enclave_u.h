...
sgx_status_t SGX_UBRIDGE(SGX_NOCONVENTION, ocall_sgx_init_quote, (sgx_target_info_t* ret_ti, sgx_epid_group_id_t* ret_gid));
#endif
#ifndef OCALL_GET_IAS_SOCKET_DEFINED__
#define OCALL_GET_IAS_SOCKET_DEFINED__
sgx_status_t SGX_UBRIDGE(SGX_NOCONVENTION, ocall_get_ias_socket, (int* ret_fd));
#endif
#ifndef OCALL_GET_QUOTE_DEFINED__
#define OCALL_GET_QUOTE_DEFINED__
sgx_status_t SGX_UBRIDGE(SGX_NOCONVENTION, ocall_get_quote, (uint8_t* p_sigrl, uint32_t sigrl_len, sgx_report_t* report, sgx_quote_sign_type_t quote_type, sgx_spid_t* p_spid, sgx_quote_nonce_t* p_nonce, sgx_report_t* p_qe_report, sgx_quote_t* p_quote, uint32_t maxlen, uint32_t* p_quote_len));
#endif
#ifndef OCALL_GET_UPDATE_INFO_DEFINED__
#define OCALL_GET_UPDATE_INFO_DEFINED__
sgx_status_t SGX_UBRIDGE(SGX_NOCONVENTION, ocall_get_update_info, (sgx_platform_info_t* platformBlob, int32_t enclaveTrusted, sgx_update_info_bit_t* update_info));
#endif
...
size_t SGX_UBRIDGE(SGX_NOCONVENTION, u_recvmsg_ocall, (int* error, int sockfd, void* msg_name, socklen_t msg_namelen, socklen_t* msg_namelen_out, struct iovec* msg_iov, size_t msg_iovlen, void* msg_control, size_t msg_controllen, size_t* msg_controllen_out, int* msg_flags, int flags));
#endif
...
size_t SGX_UBRIDGE(SGX_NOCONVENTION, u_sendmsg_ocall, (int* error, int sockfd, const void* msg_name, socklen_t msg_namelen, const struct iovec* msg_iov, size_t msg_iovlen, const void* msg_control, size_t msg_controllen, int flags));
#endif
...
sgx_status_t ecall_init_seed_node(sgx_enclave_id_t eid, sgx_status_t* retval);
sgx_status_t ecall_init_node(sgx_enclave_id_t eid, sgx_status_t* retval);
sgx_status_t ecall_create_report(sgx_enclave_id_t eid, sgx_status_t* retval, uint8_t api_key[32]);
sgx_status_t ecall_start_seed_server(sgx_enclave_id_t eid, int fd, sgx_quote_sign_type_t quote_type);
sgx_status_t ecall_request_seed(sgx_enclave_id_t eid, int fd, sgx_quote_sign_type_t quote_type);
