...
sgx_status_t SGX_UBRIDGE(SGX_NOCONVENTION, ocall_query_raw, (void* querier, const uint8_t* request, size_t request_len, uint8_t* result, size_t result_len, uint32_t* actual_result_len));
#endif
